...
setTimeout(() => {
    ...
    let arr_hello = ["Hyvää iltapäivää", "Tere pärastlõunast", "God ettermiddag", "God eftermiddag", "God eftermiddag", "Добър ден"];
    GetInfo(answer, arr_country, promo, arr_hello);
    GetInfo(answer2, arr_country, footer);
}, 600);


function GetInfo(info, arr, el, hello) {
